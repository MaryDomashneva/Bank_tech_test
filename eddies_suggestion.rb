...
#       string += format_transaction(date, statement)
#     end
#     string.chomp(' ')
#   end
#
#
#   def format_transaction(date, statement)
#     "#{format_date(date)} || #{format_float(statement[:credit_amount])} || #{format_float(statement[:debit_amount])} \
